...
/** Каталог разделов приложения. Нужен и главному экрану, и виджету поиска. */
public final class ChapterCatalog {
    ...
    public static List<Chapter> build() {
        ...
        topicsList.add(new Topics("23.30. При работе с химическими веществами, проявляющими опасные свойства", "t449"));
